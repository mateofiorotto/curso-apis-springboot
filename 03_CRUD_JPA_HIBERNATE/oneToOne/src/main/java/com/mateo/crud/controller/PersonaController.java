...
public class PersonaController {
    ...
    //1. se nos manda el objeto persona completo (el id es intocable)
    //2. llamamos al metodo editar y lo guarda
    //3. devolvemos el objeto persona
    @PutMapping("/personas/editar-nuevo")
